...
export class AppController {
  ...
  async redirect(@Query('url') url: string) {
    // CSRF protection: Check the referrer header
    const referrer = this.getReferrer();
    if (!referrer || !referrer.startsWith('https://your-allowed-origin.com')) {
  ...
  private getReferrer(): string | undefined {
    // This function should extract the referrer from the request headers
    // Implementation depends on the framework and setup
